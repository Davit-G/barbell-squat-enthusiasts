...
function TaskBlock({ num }) {
    ...
    return (
        <>
            <div className="rounded-xl shadow-md dark:shadow-none text-zinc-900 dark:text-white dark:bg-zinc-700 dark:bg-opacity-60 p-4 w-full">
    ...
    return (
        <>
            <div className='w-full py-4 pl-20 h-[50vh] flex flex-col justify-start items-start pt-8'>
                <h1 className='text-4xl font-semibold text-left dark:text-zinc-200 m-auto'>Today's tasks:</h1>
